...
export function EditTaskDrawer({ task, onClose }: { task: any, onClose: () => void }) {
  ...
  // Convert the ISO string back to datetime-local format for the input
...
const styles = {
  ...
  input: {
    padding: "16px", borderRadius: "12px", border: "1px solid var(--border-color)", backgroundColor: "rgba(255,255,255,0.05)", color: "var(--text-main)", outline: "none", fontSize: "16px"
  },
  ...
  submitBtn: {
    marginTop: "10px", padding: "18px", borderRadius: "16px", backgroundColor: "var(--primary-color)", color: "#fff", fontWeight: "bold", fontSize: "18px", textAlign: "center" as const, border: "none", cursor: "pointer"
  }
};
